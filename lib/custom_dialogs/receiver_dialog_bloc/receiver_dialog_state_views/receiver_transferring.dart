          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text("Please don't close the app!", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.onBackground), textAlign: TextAlign.center),
              ),
              SizedBox(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            child: Row(
                              children: [
                                Text("Remaining files  ", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.onSurfaceVariant)),
                                Container(
                                  decoration: BoxDecoration(
                                    shape: BoxShape.circle,
                                    color: Theme.of(context).colorScheme.onSurfaceVariant,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(files.length.toString(), style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.surfaceVariant)),
                                  ),
                                )
                              ],
                            ),
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Padding(
                                      padding: const EdgeInsets.symmetric(vertical: 2.0),
                                      child: Text("${speed.toStringAsFixed(2)} MB/s", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.onSurfaceVariant)),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.symmetric(vertical: 2.0),
                                      child: Text("${progress.toStringAsFixed(2)}%", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Theme.of(context).colorScheme.onSurfaceVariant)),
                                    ),
                                  ],
                                )
                              ],
